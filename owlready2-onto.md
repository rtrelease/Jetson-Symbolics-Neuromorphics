...
Using this as a starting point for a new Owlready2 installation on an AGX Orin (JP 5.1.2), the following image shows it ina few lines of Python in a simple Jupyter Notebook for accessing a local subset of the Gene Ontology *(go)*.  To the left, Protege displays an expanded entity-based view of go-basic.owl.
