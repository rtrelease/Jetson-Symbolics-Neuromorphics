...
##### =---> Integrated neuromorphic neocortical microcircuit simulator with functional MO+ CircuitPython analog 'neurons' and M4 hybrid controller providing 'thalamic input' pulse trains
