 ...
 *=--> **Fig. 1:** ImageJ displays a DICOM MRI section with cross-hair pointer placed over the optic nerve, and Protege shows the ontology search and appropriate specific FMA.owl *left optic nerve* entity information.  AGX Orin*
 ...
 *=--> **Fig 2:** ImageJ shows a DICOM MRI section with cross-hair pointer over the left optic nerve, and Protege displays the appropriate OpenGalen.owl general optic nerve entity information.  Xeon dual RTX workstation*
