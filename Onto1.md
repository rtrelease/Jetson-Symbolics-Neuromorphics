...
Across the same time frame, application of ontologies has tapered off, so that effective anatomical inference with medical imaging is now associated with deep learning systems like NVIDIA CLARA.
