...
Create an image of a Jetson Xavier NX computer vision system running an ImageNet application viewing a coffee mug, while a neuromorphic cortical microcircuit prototype is parked below the web cam field.
...
**Been there, done that 0:** Late-'70s, my first laboratory computer was a PDP-12 that ran FFTs on EEG and ECG
