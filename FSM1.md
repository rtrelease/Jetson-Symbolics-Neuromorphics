...
Computational automata can be ranked by their mathematic problem-solving capacity as depicted below.  Automated mathematical problem solving capability is greatest in Turing Machines, and this hierarchy was first codified in the [Church-Turing Thesis](https://plato.stanford.edu/entries/church-turing/).
