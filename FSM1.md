...
For current AI Lab spiking neurons projects using multiple ARM32 microcontrollers, FSM code is replacing more conventionally programmed loops and IO handler functions for autonomous neuromorphic simulation. These MCUs are programmed in CircuitPython using basic builtin IO classes, objects, and functions for states and transitions.
