...
For current spiking neurons projects using multiple ARM32 microcontrollers, FSM code is replacing more conventional loops and IO handler functions for autonomous neuromorphic simulations. These MCUs are programmed in CircuitPython using builtin state, transition, and IO classes and objects.
