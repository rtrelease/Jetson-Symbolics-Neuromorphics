...
For current AI Lab spiking neuron modeling projects using multiple ARM32 microcontrollers, FSM model code is replacing more conventionally programmed loops and IO handler functions. These MCUs are programmed with CircuitPython using basic builtin IO classes, objects, and functions for states, transitions, and sensing.
