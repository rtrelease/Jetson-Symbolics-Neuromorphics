...
**AI Lab Notes**
 - *Updates 2025* - [Latest Jetson CLIPS binaries](https://github.com/rtrelease/Jetson-Symbolics-Neuromorphics/blob/main/JetsonCLIPS642Binaries.md) - - - [GraalVM 23 for Linux aarch64](https://www.graalvm.org/downloads/#) ~ Russell & Norvig ***AI Modern Approach*** textbook [Python](https://github.com/aimacode/aima-python) and [Java](https://github.com/aimacode/aima-java) code Examples
