# Jetson-Symbolics + Neuromorphics
...
**AI Lab Notes**
 ...
 36. [**AGX Thor Developer Kit release specifications**](https://nvdam.widen.net/s/p9z68r5znh/robotics-and-edge-ai-datasheet-jetson-thor-devkit-nvidia-us-web) - [Carrier Board specs](https://developer.download.nvidia.com/assets/embedded/secure/jetson/thor/docs/Jetson-AGX-Thor-Developer-Kit-Carrier-Board-Specification_SP-12533-001_v1.0.pdf?__token__=exp=1755885534~hmac=9e72acc54e28933fdbfdc5c536dbc158ca86642d2b8ac8aa6f444fc86f2a07b7&t=eyJscyI6InlzZW8iLCJsc2QiOiJodHRwczovL3Iuc2VhcmNoLnlhaG9vLmNvbS8iLCJuY2lkIjoiZW0tcHJvZC03MzA4MDIifQ==) - [AGX Orin System Comparison and Transition Guide](https://developer.download.nvidia.com/assets/embedded/secure/jetson/thor/docs/Jetson-Orin-Thor-Migration-Application-Note_DA-11926-001v1.1.pdf?__token__=exp=1755885794~hmac=45435f4c147b562169d6882aa5a300d9110c047fa1af2318ec4c7988b5ac33c8&t=eyJscyI6InlzZW8iLCJsc2QiOiJodHRwczovL3Iuc2VhcmNoLnlhaG9vLmNvbS8iLCJuY2lkIjoiZW0tcHJvZC03MzA4MDIifQ==)
 38. **ELIZA's Grandchildren** and Computational Psychiatry on the Edge in 2025
 39. [**Ollama Server**](https://www.jetson-ai-lab.com/tutorial_ollama.html#ollama-server) runs most available open source LLMs on AGX Orin - [Comparing models](https://github.com/rtrelease/Jetson-Symbolics-Neuromorphics/blob/main/OllamaEvals.md)' operational capabilities for ***computational anatomy*** tasks
 40. ***Analyzing and Transforming Symbolic Modeling Code with Large Language Models***
 ...
 42. **Parse this: Reifying *neuromorpho-symbolic AI***
 43. **<ins>Polymorphic Neural Systems</ins>:** Integrating multiple structural paradigms for new autonomous machines
 44. [**AGX Orin Dev Kit A/V Exoskeleton:**](https://github.com/rtrelease/Jetson-Symbolics/blob/main/OrinExoSkel.md) Supporting sound and vision
 45. **Toward a silicon [amanuensis](https://en.wikipedia.org/wiki/Amanuensis)**? [Reflections](https://github.com/rtrelease/Jetson-Symbolics/blob/main/AI-HypeCycle2022.md) on personal research lab HPC+AI in the Age of Big Data Sciences and Teams in *The Cloud*
 46. **The *Neuroscientist's Edge* HPC**: Workstation RTX GPUs, AGX Orin + Neurosymbolic and Neurobiological Modeling and Imaging Tools
 47. **LXXIV and counting**: Neuromorphic development as a [Diamond](https://en.wikipedia.org/wiki/Marian_Diamond)-[Scheibel](https://en.wikipedia.org/wiki/Arnold_Scheibel) gero-protective agent/process
 48. **Ontogenesis:** Legacy computing technology and artificial intelligence [publications](https://github.com/rtrelease/Jetson-Symbolics-Neuromorphics/blob/main/LegacyPublications.md)
