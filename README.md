...
**AI Lab Notes**
 ...
 7. **Toward a silicon [amanuensis](https://en.wikipedia.org/wiki/Amanuensis)**: [Reflections](https://github.com/rtrelease/Jetson-Symbolics/blob/main/AI-HypeCycle2022.md) on personal research lab HPC+AI in the Age of Big Data Sciences and Teams in *The Cloud*
 8. **The Neuroscientist's Edge HPC**: RTX GPUs, AGX Orin + Neurosymbolic and Neurobiological Modeling Tools
