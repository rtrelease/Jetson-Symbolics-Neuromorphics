...
**AI Lab Notes**
 ...
 6. **[Integrating](https://github.com/rtrelease/Jetson-Symbolics/blob/main/Monai0.md) [MONAI](https://monai.io/index.html) [imaging:](https://github.com/Project-MONAI/tutorials/blob/main/2d_classification/mednist_tutorial.ipynb)** Adding another build chain for neurosymbolic fusion
 7. **Toward a silicon [amanuensis](https://en.wikipedia.org/wiki/Amanuensis)**: Reflections on personal research lab HPC+AI in the Age of Big Data Sciences and Teams in *The Cloud*
 8. **The Neuroscientist's Edge HPC**: AGX Xavier and Orin + Neurosymbolic and Neurobiological Modeling Tools
