...
For a first experiment with modeling ELIZA-like psychoanalitic behavior in a LLaMa 2-13B GPTQ model with essentially base chat and character settings including the name ELIZA.
