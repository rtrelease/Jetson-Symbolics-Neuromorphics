...
Previous AI Lab Notes covered using AGX Orin with USB-interfaced AVR (Arduino) and ARM Cortex M [microcontroller boards for edge-based modeling, neuromorphic simulation,](https://github.com/rtrelease/Jetson-Symbolics/blob/main/M4_Controller-CorticalMicrocircuitLayout.md) data acquisition and process control subsystem applications.
...
After considering Thonny and the range of other editors/IDEs, I ended up going with the 'hacker-friendly' approach of using a Jetson platform standard editor, GEdit, and the *screen* serial console.  For the Xeon workstation, Adafruit-recommended Mu worked best.
