...
Previous AI Lab Notes covered using AGX Orin with USB-interfaced AVR (Arduino) and ARM Cortex M [microcontrollers for modeling, stimulation,](https://github.com/rtrelease/Jetson-Symbolics/blob/main/M4_Controller-CorticalMicrocircuitLayout.md) and process control applications.
...
In 'good old basic programming', Python and CircuitPython can certainly be coded with a plain text editor and a serial console/terminal connected to the target MCU board.  
